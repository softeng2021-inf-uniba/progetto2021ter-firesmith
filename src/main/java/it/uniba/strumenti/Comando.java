...
public class Comando {
    ...
    public static String gestisciRegex(final Mossa mossa, String comando) {
        ...
        Pattern p1 = Pattern.compile(Costante.SPOSTAMENTO);
        Pattern p2 = Pattern.compile(Costante.PRESA_S);
        Pattern p3 = Pattern.compile(Costante.PRESA_M);
        ...
        if (!comando.equals("-h") && !comando.equals("--help")) {
            try {
                if ((array.length > 1)) {
                    ...
                    String posInizialeTemp = array[Costante.ZERO];
                    String posFinaleTemp = array[Costante.UNO];
                    ...
                    if (array.length > Costante.DUE) {
                        String posFinale2Temp = array[Costante.DUE];
                        posFinale2 = Integer.parseInt(posFinale2Temp);
                        mossa.setPosizione3(posFinale2);

                        if (array.length > Costante.TRE
                                && !array[Costante.TRE].equals("")) {

                            String posFinale3Temp = array[Costante.TRE];
